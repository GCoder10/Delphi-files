...
type
  TfMainPanel = class(TForm)
    ...
    ibcspGetWorkersData:                         TIBCStoredProc;
    ...
    ibcspCheckDataBeforeImport:                  TIBCStoredProc;
    ibcspImportCSV:                              TIBCStoredProc;
...
begin
       if message.CmdType and $fff0=SC_CLOSE then
          ...
          begin
                ...
                ibcspCheckDataBeforeImport.Close;
                ibcspImportCSV.Close;
                ibcspGetWorkersData.Close;
...
begin
      ...
      begin
          ...
          fInfoBox.pbFInfoBox.Style := pbstMarquee;
          fInfoBox.Show;
